...
\begin{itemize}
    ...
    \item Re-organized section ordering, moved Collaboration with Git section to the end of Intermediate Git.
    \item Update images used for Git installation on Mac.
    \item Introduced "{git add -A}" and "{git add .}".
    \item Explained commit hash.
    \item Started some sections at new page for better page alignment.
\end{itemize}
