...
We targetted individuals that were either new to or experienced with Git.  The reason for this is that we envision our manual primary usage to be an introduction to the basics of Git for beginners as well as a quick reference for Git commands for intermediate to advanced users.
