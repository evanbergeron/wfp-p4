...
Feedback:
\begin{itemize}
\item Document is very long
\item Was typing the commands without strong understand of what was actually being done
\item The Problem/Solution/Discussion should help because it tells you exactly what problem each command is addressing
\item A section on how to use the document would be helpful
\item More visuals besides just the graphs of project structure
\item Leave out some of the in depth technical discussion
\item More consistency in descriptions and voice/tone
\end{itemize}
...
\begin{itemize}
    \item Fixed grammar errors.
    \item Removed dangling sections (orphans).
    \item Re-organized section ordering (i.e. moved Collaboration with Git section to the end of Intermediate Git).
    \item Updated images used for Git installation on Mac.
    \item Introduced "{git add -A}" and "{git add .}".
    \item Explained commit hash.
    \item Started some sections at a new page for better page alignment.
\end{itemize}
